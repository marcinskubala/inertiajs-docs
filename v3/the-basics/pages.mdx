...
<ClientSpecific>
  As you can see, there is nothing Inertia specific within this template. This
  is just a typical <VueSpecific>Vue</VueSpecific>
  <ReactSpecific>React</ReactSpecific>
  <SvelteSpecific>Svelte</SvelteSpecific> component.
</ClientSpecific>
